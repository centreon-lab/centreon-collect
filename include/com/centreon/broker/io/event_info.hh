...
class event_info {
 ...
 private:
  ...
  //std::function<io::data*()> _constructor;
 ...
 public:
    ...
    * @param ops Event operations (constructor, ...).
    * @param entries Event property mapping
    * @param table_v2 SQL table of event in version 2 (the only one).
    */
